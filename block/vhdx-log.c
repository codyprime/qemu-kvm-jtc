...
static void vhdx_print_guid(MSGUID *guid)
{
    int i;
...
static void vhdx_log_hdr_print(VHDXLogEntryHeader *hdr, BDRVVHDXState *s)
{
                          ...
                          VHDXLogSequence *logs)
{
    ...
    while(cnt--) {
        ...
        /* if the log shows a FlushedFileOffset larger than our current file size,
         * then that means the file has been truncated / corrupted, and we must refused
         * to open it / use it */
